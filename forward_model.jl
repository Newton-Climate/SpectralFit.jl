...
#            spectra = fit_pT!(x, measurement, spectra, inversion_setup)
#        elseif inversion_setup["fit_pressure"] && #inversion_setup["fit_temperature"] == false
#            println(typeof(x))
#            spectra = fit_pressure!(x, measurement, spectra, inversion_setup)
#        elseif inversion_setup["fit_temperature"] && #inversion_setup["fit_pressure"] == false
#            spectra = fit_temperature!(x, measurement, spectra, inversion_setup)
        #        end
        if inversion_setup["fit_temperature"] || inversion_setup["fit_pressure"]
            spectra = construct_spectra!(spectra, T=x["temperature"], p=x["pressure"])
        end
